...
export default function Analytics() {
  return (
    <div>
      ...
      >
        <StatCard title="Demandes" value="1 245" trend="+12%" icon={FileText} />

        <StatCard title="Citoyens" value="5 432" trend="+8%" icon={Users} />
        ...
        <StatCard title="Agents" value="38" trend="+2%" icon={UserCog} />
      </div>
        ...
        >
          ...
          <ResponsiveContainer width="100%" height={320}>
            <LineChart data={activityData}>
              ...
              <YAxis />
              <Tooltip />
              <Line type="monotone" dataKey="demandes" stroke="#2563EB" />
      ...
      >
        ...
        <ResponsiveContainer width="100%" height={320}>
          <BarChart data={activityData}>
            ...
            <YAxis />
            <Tooltip />
            <Bar dataKey="demandes" fill="#2563EB" />
          </BarChart>
        </ResponsiveContainer>
      </div>
    </div>
